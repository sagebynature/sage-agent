...
export class CommandRegistry {
  ...
  private registerDefaults() {
    const defaults: Omit<CommandDefinition, 'handler'>[] = [
      ...
      { name: 'verbosity', description: 'Set event verbosity level', aliases: ['verb'] },
      { name: 'events', description: 'Show or navigate lifecycle events', aliases: [] },
      { name: 'filters', description: 'Filter lifecycle event feed', aliases: [] },
